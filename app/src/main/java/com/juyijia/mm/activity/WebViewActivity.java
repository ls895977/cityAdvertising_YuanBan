...
public class WebViewActivity extends AbsActivity {
    ...
    protected void main() {
        ...
        Log.e("aa", "-------------webview===LoginActivity.token====" +AppConfig.getInstance().getToken());
        if (AppConfig.getInstance().getToken().equals("")) {
            mWebView.loadUrl(url);
            Log.e("aa", "-------------1111====" +AppConfig.getInstance().getToken());
        } else {
            HashMap<String, String> hashMap = new HashMap<>();
            hashMap.put("token", AppConfig.getInstance().getToken());
            mWebView.loadUrl(url+"&token="+AppConfig.getInstance().getToken(),hashMap);
            Log.e("aa", "-------------222====" +url+"&token="+AppConfig.getInstance().getToken());
        }
    }
