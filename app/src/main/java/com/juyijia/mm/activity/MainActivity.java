...
import com.juyijia.mm.bean.BonusBean;
import com.juyijia.mm.bean.ConfigBean;
import com.juyijia.mm.bean.LiveBean;
import com.juyijia.mm.bean.VideoBean;
import com.juyijia.mm.custom.TabButtonGroup;
import com.juyijia.mm.dialog.MainStartDialogFragment;
...
import com.juyijia.mm.interfaces.MainStartChooseCallback;
import com.juyijia.mm.presenter.CheckLivePresenter;
import com.juyijia.mm.utils.DialogUitl;
import com.juyijia.mm.utils.DpUtil;
import com.juyijia.mm.utils.LiveStorge;
import com.juyijia.mm.utils.LocationUtil;
import com.juyijia.mm.utils.ProcessResultUtil;
import com.juyijia.mm.utils.ToastUtil;
import com.juyijia.mm.utils.VersionUtil;
import com.juyijia.mm.utils.VideoStorge;
import com.juyijia.mm.utils.WordUtil;
import com.juyijia.mm.views.AbsMainViewHolder;
import com.juyijia.mm.views.BonusViewHolder;
import com.juyijia.mm.views.MainHomeShopingViewHolder;
import com.juyijia.mm.views.MainListViewHolder;
import com.juyijia.mm.views.MainMeViewHolder;
import com.juyijia.mm.views.MainNearViewHolder;
...
//
//        Key
//        0d33b836f07e4f9aae4e5af8c6cc4aeb
//
//        LicenseUrl
//        http://license.vod2.myqcloud.com/license/v1/be376b26e8c13acac10d56308f0c549b/TXUgcSDK.licence
//
//        开始日期
//        2019-10-12
//
//        结束日期
//        2019-10-25
//https://blog.csdn.net/wjk343977868/article/details/69372376
public class MainActivity extends AbsVideoActivity {
...
//            @Override
//            public void onClick(View v) {
//                IncomeRecordActivity.forward(mContext);
//            }
//        });
        boolean showInvite = getIntent().getBooleanExtra(Constants.SHOW_INVITE, false);
        boolean firstLogin = getIntent().getBooleanExtra(Constants.SHOW_INVITE, false);
...
//        mViewHolders[0] = new MainHomeViewHolder2(mContext, mViewPager,firstLogin);//老首页
        mViewHolders[0] = new MainHomeShopingViewHolder(mContext,mViewPager);//老首页
...
//        EventBus.getDefault().register(this);
     ...
     * @param position
     */
    private void videoStateControl(int position) {
        isWhiteStateBar(position == 0);
//        ((MainHomeViewHolder3) mViewHolders[0]).setPlayVideo(position == 0);
    }
...
//            }
    ...
    public static void forward(Context context, boolean showInvite) {
        forward(context, showInvite, false);
    }

    public static void forward(Context context, boolean showInvite, boolean firstLogin) {
...
//    }
    ...
    public void setVideoBtm(VideoBean mVideoBean) {
        super.setVideoBtm(mVideoBean);
        mBottom.setVisibility(mVideoBean.isAd() ? View.GONE : View.VISIBLE);
    }
