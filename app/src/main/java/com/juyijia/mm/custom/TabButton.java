...
public class TabButton extends LinearLayout {
    ...
    private int mTextColor, mChoseTextColor;
    ...
    public TabButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mChoseTextColor = (int) ta.getColor(R.styleable.TabButton_tbn_selected_text_color, 0xff000000);
        ta.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        mText.setText(mTip);
        if (mChecked) {
            mText.setTextColor(mChoseTextColor);
        } else {
            mImg.setImageResource(mUnSelectedIcon);
        }
        addView(mImg);
