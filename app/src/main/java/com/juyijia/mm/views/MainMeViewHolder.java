...
import com.juyijia.mm.activity.CommunityAgentActivity;
import com.juyijia.mm.activity.EditProfileActivity;
import com.juyijia.mm.activity.FansActivity;
import com.juyijia.mm.activity.FollowActivity;
import com.juyijia.mm.activity.LiveRecordActivity;
import com.juyijia.mm.activity.MyCoinActivity;
import com.juyijia.mm.activity.MyProfitActivity;
import com.juyijia.mm.activity.MyVideoActivity;
import com.juyijia.mm.activity.SettingActivity;
import com.juyijia.mm.activity.WebViewActivity;
import com.juyijia.mm.adapter.MainMeAdapter;
    ...
    private void showData(UserBean u, List<UserItemBean> list) {
        ...
        if (list != null && list.size() > 0) {
            if (mAdapter == null) {
                ...
                userItemBean.setName("小区代理");
                userItemBean.setId(-1);
                list.add(0,userItemBean );
        ...
        if (TextUtils.isEmpty(url)) {
            switch (bean.getId()) {
                ...
                case 19:
                    ...
                    break;
                case -1:
                    CommunityAgentActivity.startAct(mContext);
                    break;
