...
public class VideoPlayWrapViewHolder extends AbsViewHolder implements View.OnClickListener {
    ...
    private String mTag;
    private TextView mBtnCouponNum;
    private ImageView mBtnCoupon;
    private RelativeLayout rl_video_right_btn;
    ...
    public void init() {
        ...
        mBtnCoupon = (ImageView) findViewById(R.id.btn_coupon);
        mBtnCouponNum = (TextView) findViewById(R.id.coupon_num);
        ...
        rl_video_right_btn = (RelativeLayout) findViewById(R.id.rl_video_right_btn);
    ...
    public void setRightBtnVisibility(boolean isVisibility){
        rl_video_right_btn.setVisibility(isVisibility?View.VISIBLE:View.GONE);
    }
    ...
    private void clickCoupon() {
        ((AbsVideoActivity) mContext).openCouponActivity(mVideoBean);
    }
    ...
    private void clickComment() {
            ((AbsVideoActivity) mContext).openCommentWindow(mVideoBean);
    }
    ...
    private void clickShare() {
        ...
        ((AbsVideoActivity) mContext).clickShare( mVideoBean);
...
//        fragment.show(((AbsVideoActivity) mContext).getSupportFragmentManager(), "VideoShareDialogFragment");
    }
