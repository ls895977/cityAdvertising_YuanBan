...
import com.juyijia.mm.utils.SpUtil;
...
//    public static final String HOST = "https://livenew.yunbaozb.com";
    public static final String HOST = "http://juyijia.wtwx.cn";
    public static final String HOST1 = "http://juyijia.wtwx.cn";//首页栏目商标
    public static final String HOST2 = "https://waimai.juyijia.cn/app/wxapp.php";//首页列表数据
    //外部sd卡
    ...
    public String getAddress() {
        if (TextUtils.isEmpty(address)) {
            address = SpUtil.getInstance().getStringValue(SpUtil.LOCATION_DISTRICT);
        }
     ...
     * @param city     市
     */
    public void setLocationInfo(double lng, double lat, String province, String city, String district,String address1) {
        mLng = lng;
        mLat = lat;
        mProvince = province;
        mCity = city;
